...
bool Level::Convert(int* playerX, int* playerY)
{
    ...
    for (int y = 0; y < m_height; y++)
    {
        for (int x = 0; x < m_width; x++)
        {
            ...
            case 'R':
                m_pLevelData[index] = ' ';
                m_pActors.push_back(new Door(x, y, ActorColor::Red, ActorColor::RedSolid));
                break;
            case 'G':
                m_pLevelData[index] = ' ';
                m_pActors.push_back(new Door(x, y, ActorColor::Green, ActorColor::GreenSolid));
                break;
            case 'B':
                m_pLevelData[index] = ' ';
                m_pActors.push_back(new Door(x, y, ActorColor::Blue, ActorColor::BlueSolid));
                break;
            case 'X':
                m_pLevelData[index] = ' ';
